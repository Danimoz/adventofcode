...
var filePath = '/home/daniel/Documents/repos/adventofcode/2023/inputs/day2.txt';
function solution(filePath) {
    var _a, e_1, _b, _c;
    return __awaiter(this, void 0, void 0, function () {
        var file, total, _loop_1, _d, _e, _f, e_1_1;
            ...
            switch (_g.label) {
                ...
                case 2:
                    ...
                    _loop_1 = function () {
                        ...
                        var gameId = lineArray[0].split(' ')[1];
                        var sets = lineArray[1].split('; ');
                        var validGame = true;
                        sets.forEach(function (set) {
                            var cubes = set.split(', ').map(function (cube) { return cube.split(' '); });
                            cubes.forEach(function (_a) {
                                var number = _a[0], color = _a[1];
